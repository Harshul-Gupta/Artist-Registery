...
<body>
  ...
  <div class="card">
    ...
    <p class="subtitle">INPUT TWO NUMBERS — GET THE TRUTH</p>

    <form action="add" >
      <div class="fields">
        <div class="field-group">
          <label for="num1">First</label>
          <input type="number" id="num1" name="num1" placeholder="0" required />
        </div>
        <div class="operator">+</div>
        <div class="field-group">
          <label for="num2">Second</label>
          <input type="number" id="num2" name="num2" placeholder="0" required />
        </div>
      </div>
